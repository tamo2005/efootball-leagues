...
function DatabasePanel({ database, user, scorerReviews, onAnalyzeScorerReviews, onApproveScorerReview, onRejectScorerReview, scorerReviewBusy }: { database: LeagueDatabase; user: UserAccount; scorerReviews: BackendScorerReview[]; onAnalyzeScorerReviews: () => void; onApproveScorerReview: (reviewId: number, approvedName: string) => void; onRejectScorerReview: (reviewId: number) => void; scorerReviewBusy: boolean }) {
